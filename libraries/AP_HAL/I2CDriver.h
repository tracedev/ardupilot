...
public:
    ...
    virtual uint8_t write(uint8_t addr, uint16_t len, uint8_t* data) = 0;
    ...
    virtual uint8_t writeRegisters(uint8_t addr, uint8_t reg,
                                   uint16_t len, uint8_t* data) = 0;

    /* read: for i2c devices which do not obey register conventions */
    virtual uint8_t read(uint8_t addr, uint16_t len, uint8_t* data) = 0;
